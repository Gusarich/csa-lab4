...
REQUIRED_GOLDENS = {
    ...
    "assembler_immediate_overflow.yml",
    "assembler_unaligned_org.yml",
    "branch_byte_offset.yml",
    "fault_bad_encoding.yml",
    "fault_unaligned_lw.yml",
}
PRIMARY_GOLDEN_EXAMPLES = {
    "hello.yml": "hello.asm",
    "cat.yml": "cat.asm",
    "hello_user_name.yml": "hello_user_name.asm",
    "hello_user_name_long.yml": "hello_user_name.asm",
    "sort.yml": "sort.asm",
    "sort_invalid_token.yml": "sort.asm",
    "double_precision.yml": "double_precision.asm",
    "prob2_100.yml": "prob2.asm",
    "prob2_zero.yml": "prob2.asm",
    "prob2_one.yml": "prob2.asm",
    "prob2_max.yml": "prob2.asm",
    "prob2_range.yml": "prob2.asm",
    "prob2_invalid.yml": "prob2.asm",
    "prob2_empty.yml": "prob2.asm",
    "prob2_overrun.yml": "prob2.asm",
